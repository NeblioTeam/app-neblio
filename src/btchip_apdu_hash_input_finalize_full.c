...
#include <string.h> // memset, memcmp, memmove,
...
void handle_output_parsing_number_outputs(btchip_context_t *btchip_context_D, uint32_t *discardSize, bool *processed)
{
...
void handle_output_parsing_output(btchip_context_t *btchip_context_D, uint32_t *discardSize, bool *processed)
{
...
bool handle_output_state()
{
    ...
    {
        handle_output_parsing_number_outputs(&btchip_context_D, &discardSize, &processed);
    }
    break;

    case BTCHIP_OUTPUT_PARSING_OUTPUT:
    {
        handle_output_parsing_output(&btchip_context_D, &discardSize, &processed);
    }
    break;
