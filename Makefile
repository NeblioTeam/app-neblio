...
# Neblio
DEFINES += BIP44_COIN_TYPE=146 BIP44_COIN_TYPE_2=1 COIN_P2PKH_VERSION=53 COIN_P2SH_VERSION=112 COIN_FAMILY=2 COIN_COINID=\"Neblio\" COIN_COINID_HEADER=\"NEBLIO\" COIN_COLOR_HDR=0x3790CA COIN_COLOR_DB=0x9BC8E5 COIN_COINID_NAME=\"NEBLIO\" COIN_COINID_SHORT=\"NBL\" COIN_NATIVE_SEGWIT_PREFIX=\"bc\" COIN_KIND=COIN_KIND_PEERCOIN COIN_FLAGS=FLAG_PEERCOIN_SUPPORT
APPNAME ="Neblio"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
